...
int main(int argc, char* argv[])
{
    ...
    Shader ourShader("shaders/立方体几何类测试.vs", "shaders/立方体几何类测试.fs");

    BoxGeometry boxGeometry(1.0, 1.0, 1.0, 1.0, 100.0, 1.0);
    ...
    // 加载图片
    data = stbi_load("./textures/dot.png", &width, &height, &nrChannels, 0);
