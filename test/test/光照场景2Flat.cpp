...
int main()
{
    ...
    //Shader lightingShader("shaders/光照场景2物体Flat.vs", "shaders/光照场景2物体Flat.fs");
    //Shader lightingShader("shaders/光照场景2物体Gouraud.vs", "shaders/光照场景2物体Gouraud.fs");
    Shader lightingShader("shaders/光照场景2物体.vs", "shaders/光照场景2物体.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 绘制立方体
        glm::mat4 model = glm::mat4(1.0f); // 立方体的模型矩阵
        ...
        modelSphere = glm::translate(modelSphere, glm::vec3(1.5f, 0.0f, 0.0f)); // 将球体平移到新的位置
