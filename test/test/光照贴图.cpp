...
int main()
{
    ...
    Shader lightingShader("shaders/光照贴图.vs", "shaders/光照贴图.fs");
    Shader lightCubeShader("shaders/光照贴图光源.vs", "shaders/光照贴图光源.fs");
    ...
    unsigned int specularMap = loadTexture("./textures/container2.png");
    lightingShader.use();
